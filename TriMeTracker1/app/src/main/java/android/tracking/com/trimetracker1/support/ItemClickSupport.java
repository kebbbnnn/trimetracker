package android.tracking.com.trimetracker1.support;
...
public class ItemClickSupport {
    ...
    public static ItemClickSupport addTo(@NonNull RecyclerView view) {
        ...
        if (support == null) {
            ...
            Log.w(ItemClickSupport.class.getName(), "RecyclerView already has ItemClickSupport.");
        }
        return support;
    }
    ...
    public static ItemClickSupport removeFrom(@NonNull RecyclerView view) {
        ...
        if (support != null) {
            ...
            Log.w(ItemClickSupport.class.getName(), "RecyclerView does not have ItemClickSupport.");
        }
        return support;
    }
